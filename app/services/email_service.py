...
class EmailService:
    ...
    @staticmethod
    def _get_password_reset_email_html(reset_url: str, mobile_reset_url: str) -> str:
...
<head>
    ...
    <title>Reset your password - SoundScore</title>
</head>
<body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; background-color: #f3f4f6;">
    <!-- Preheader text (shows in email preview) -->
    <div style="display: none; max-height: 0; overflow: hidden;">
        Reset your SoundScore password. This link expires in 15 minutes.
    </div>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 32px 40px;">
                            <h2 style="margin: 0 0 16px 0; color: #111827; font-size: 22px; font-weight: bold;">Reset your password</h2>
                            <p style="margin: 0 0 24px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                                We received a request to reset your password. Use the button below to create a new one. This link expires in <strong>15 minutes</strong>.
                            </p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="center" style="padding: 8px 0 24px 0;">
                                        ...
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{reset_url}" style="display: inline-block; padding: 14px 40px; background-color: #722F37; color: #ffffff; text-decoration: none; font-weight: bold; font-size: 16px; border-radius: 6px;">Reset Password</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin: 0 0 24px 0; color: #6b7280; font-size: 14px; line-height: 1.6; text-align: center;">
                                Using the SoundScore app?
                                <a href="{mobile_reset_url}" style="color: #722F37; font-weight: bold;">Open this link in the app</a>.
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 20px 40px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                                This email was sent by SoundScore.<br>
...
"""
    ...
    async def send_password_reset_email(self, to_email: str, reset_token: str) -> bool:
        ...
        mobile_reset_url = f"soundscore://reset-password?token={reset_token}"

        if not settings.resend_api_key:
            print(f"[DEV MODE] Password reset link: {reset_url}")
            return True

        html_content = self._get_password_reset_email_html(reset_url, mobile_reset_url)

        try:
            params: resend.Emails.SendParams = {
                "from": "SoundScore <noreply@soundscore.com.br>",
                "to": [to_email],
                "subject": "Reset your password - SoundScore",
                "html": html_content,
            }
